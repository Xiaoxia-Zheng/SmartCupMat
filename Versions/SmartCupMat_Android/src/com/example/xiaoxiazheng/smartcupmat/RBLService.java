...
/**
 * Service for managing connection and digitalData communication with a GATT server
	...
	public void setCharacteristicNotification(
		...
		if (UUID_BLE_SHIELD_RX.equals(characteristic.getUuid())) {
			BluetoothGattDescriptor descriptor = characteristic
					.getDescriptor(UUID
							.fromString(com.example.xiaoxiazheng.smartcupmat.RBLGattAttributes.CLIENT_CHARACTERISTIC_CONFIG));
			descriptor
